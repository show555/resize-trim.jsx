...
uDlg.trimPnl.trimTypeText    = uDlg.trimPnl.add( "statictext",   { x:15,  y:10, width:85,  height:20  }, "トリムタイプ:" );
uDlg.trimPnl.trimType        = uDlg.trimPnl.add( "dropdownlist", { x:110, y:8, width:100, height:22  }, trimTypeList );
uDlg.trimPnl.widthLongText   = uDlg.trimPnl.add( "statictext",   { x:50,  y:40, width:50,  height:20  }, "幅:" );
uDlg.trimPnl.widthLong       = uDlg.trimPnl.add( "edittext",     { x:110, y:38, width:50,  height:22  }, settings.trim.width );
uDlg.trimPnl.widthLongUnit   = uDlg.trimPnl.add( "statictext",   { x:165, y:40, width:20,  height:20  }, "px" );
uDlg.trimPnl.heightShortText = uDlg.trimPnl.add( "statictext",   { x:50,  y:70, width:50,  height:20  }, "高さ:" );
uDlg.trimPnl.heightShort     = uDlg.trimPnl.add( "edittext",     { x:110, y:68, width:50,  height:22  }, settings.trim.height );
uDlg.trimPnl.heightShortUnit = uDlg.trimPnl.add( "statictext",   { x:165, y:70, width:20,  height:20  }, "px" );
...
uDlg.resizePnl.overwrite     = uDlg.resizePnl.add( "checkbox",     { x:15,  y:95, width:350, height:20  }, "リサイズ後同じ階層に保存する（同形式の場合上書き）" );
uDlg.resizePnl.saveDirText   = uDlg.resizePnl.add( "statictext",   { x:15,  y:122, width:60,  height:20  }, "保存先:" );
uDlg.resizePnl.saveDir       = uDlg.resizePnl.add( "edittext",     { x:85,  y:120, width:110, height:22  }, settings.save.dir );
